...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        /// <summary>
        /// Key for DealsTemplate caching
        /// </summary>
        /// <remarks>
        /// {0} : deals template id
        /// </remarks>
        public const string DEALS_TEMPLATE_MODEL_KEY = "Nop.pres.dealstemplate-{0}";
        public const string DEALS_TEMPLATE_PATTERN_KEY = "Nop.pres.dealstemplate";

        /// <summary>
        /// Key for PreSaleTemplate caching
        /// </summary>
        /// <remarks>
        /// {0} : presale template id
        /// </remarks>
        public const string PRESALE_TEMPLATE_MODEL_KEY = "Nop.pres.presaletemplate-{0}";
        public const string PRESALE_TEMPLATE_PATTERN_KEY = "Nop.pres.presaletemplate";        
        ...
        /// <summary>
        /// Key for TopBrandsTemplate caching
        /// </summary>
        /// <remarks>
        /// {0} : manufacturer template id
        /// </remarks>
        public const string TOPBRANDS_TEMPLATE_MODEL_KEY = "Nop.pres.topbrandstemplate-{0}";
        public const string TOPBRANDS_TEMPLATE_PATTERN_KEY = "Nop.pres.topbrandstemplate";
