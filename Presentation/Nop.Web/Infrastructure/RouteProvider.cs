...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //get deals. The products Which has special prices from date to date
            routes.MapLocalizedRoute("Deals",
                            "deals/{categoryId}",
                            new { controller = "Catalog", action = "Deals", categoryId = UrlParameter.Optional },
                            new { categoryId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
            //get presale product. The products Which has property pre-order
            routes.MapLocalizedRoute("PreSale",
                            "presale/{categoryId}",
                            new { controller = "Catalog", action = "PreSale", categoryId = UrlParameter.Optional },
                            new { categoryId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });            
            
            //get top brand. The products Which has property is new
            routes.MapLocalizedRoute("TopBrands",
                            "topbrands/{allbrands}/{categoryId}",
                            new { controller = "Catalog", action = "TopBrands", categoryId = UrlParameter.Optional, allbrands = UrlParameter.Optional },
                            new { categoryId = @"\d+", allbrands = "all" },
                            new[] { "Nop.Web.Controllers" });

            //get cool products. The products Which has property is new
            routes.MapLocalizedRoute("Cool",
                            "cool",
                            new { controller = "Product", action = "Cool" },                            
                            new[] { "Nop.Web.Controllers" });
            //cool products RSS
            routes.MapLocalizedRoute("CoolRSS",
                            "cool/rss",
                            new { controller = "Product", action = "CoolRss" },
                            new[] { "Nop.Web.Controllers" });

            //get Gift products. The products Which has property is new
            routes.MapLocalizedRoute("Gifts",
                            "gifts",
                            new { controller = "Product", action = "Gifts" },
                            new[] { "Nop.Web.Controllers" });
            //gift products RSS
            routes.MapLocalizedRoute("GiftsRSS",
                            "gifts/rss",
                            new { controller = "Product", action = "GiftsRss" },
                            new[] { "Nop.Web.Controllers" });
        }
